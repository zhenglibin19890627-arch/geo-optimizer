...
function renderList() {
  ...
  list.querySelectorAll("[data-edit]").forEach(function (n) {
    n.addEventListener("click", function () {
      /* 带 #draft-<id> 跳转：分发页据此直接把这篇稿件打开进编辑器 */
      location.href = "/static/distribution.html#draft-" + n.getAttribute("data-edit");
    });
  });
